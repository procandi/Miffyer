...
# Windows does not include zoneinfo files, so bundle the tzinfo-data gem. @xieyinghua
gem 'tzinfo-data', '1.2017.2', platforms: [:mingw, :mswin, :x64_mingw, :ruby]
...
# handle no execjs problem in ruby version. @xieyinghua
#gem 'therubyracer'
# new no execjs problem in ruby version. @xieyinghua
...
# use db2 or oracle on all platforms, or use mssql on windows with os x
#gem 'dbi', '0.4.5'
#gem 'dbd-odbc', '0.2.5'
